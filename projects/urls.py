...
from projects.views import home, about, graphql_projects_view,edit_project, show_projects, add_project, show_sequences, add_sequence,  show_shots, add_shot, show_tasks, show_users, get_time_data, show_my_tasks, task_detail
...
urlpatterns = [
 ...
 path('ql-projects/', graphql_projects_view, name='ql-projects'),
 path('', home),
 path('about/', about),
